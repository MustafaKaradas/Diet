...
namespace DietProgram.UI.AppUI
{
    public partial class frmLunch : Form
    {
        ...
        public frmLunch(IFoodService foodService, IUserFoodInfoService foodInfoService)
        {
            InitializeComponent();
        ...
        private void btnAll_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1Search.DataSource = foods.ToList();
        }
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtSearch.Text.Length == 0)
                {
                    ...
                    dataGridView1Search.DataSource = _foodService.GetAll().Data.ToList();
                }
            }
        }
        ...
        {
            int id = this.id;
            string foodName = dataGridView1Search.SelectedRows[0].Cells["FoodName"].Value.ToString();
            double kcal = Convert.ToInt32(dataGridView1Search.SelectedRows[0].Cells["Kcal"].Value);
            double protein = Convert.ToInt32(dataGridView1Search.SelectedRows[0].Cells["Protein"].Value);
            double carbonhydrate = Convert.ToInt32(dataGridView1Search.SelectedRows[0].Cells["Carbonhydrate"].Value);
            double fat = Convert.ToInt32(dataGridView1Search.SelectedRows[0].Cells["Fat"].Value);
