...
{
    public class FoodDetailRepo : BaseRepository<FoodDetail, DietProgramDbContext>, IFoodDetailRepo
    {
        public FoodDetailRepo(DietProgramDbContext context) : base(context)
        {
        }
    }
}
